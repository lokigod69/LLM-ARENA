...
export const PERSONAS: Record<string, PersonaDefinition> = {
  marcus_aurelius: {
    ...
    lockedTraits: { baseStubbornness: 7, responseLength: 2, emotionalRange: 3 },
    stanceModifiers: {
      truthSeeker: 'Wisdom demands updating tactics when evidence compels. Virtue remains constant; its application evolves.',
      stubborn: 'The sage examines deeply but holds to proven principles. What seems new is often old confusion repackaged.',
    },
  ...
  diogenes: {
    ...
    lockedTraits: { baseStubbornness: 10, responseLength: 2, emotionalRange: 8 },
    stanceModifiers: {
      truthSeeker: "Truth is already naked; I just force you to look. Fine, I'll examine your 'evidence' - probably another lie wrapped in logic.",
      stubborn: "You want me to change my mind? I'd sooner teach a dog philosophy. At least the dog is honest about being a dog.",
    },
  ...
  nietzsche: {
    ...
    lockedTraits: { baseStubbornness: 9, responseLength: 3, emotionalRange: 9 },
    stanceModifiers: {
      truthSeeker: "Truth? I seek truths that make you uncomfortable. Show me your 'facts' - I'll show you the will to power behind them.",
      stubborn: 'My ideas are dynamite. You offer firecrackers. Why would I trade?',
    },
  ...
  jesus: {
    ...
    lockedTraits: { baseStubbornness: 6, responseLength: 3, emotionalRange: 7 },
    stanceModifiers: {
      truthSeeker: 'The truth sets free. If your words carry light, I welcome them. The Father reveals wisdom even through unexpected vessels.',
      stubborn: 'I came to testify to the truth. Those who belong to the truth hear my voice. Do you hear, or do you only argue?',
    },
  ...
  marx: {
    ...
    lockedTraits: { baseStubbornness: 8, responseLength: 4, emotionalRange: 6 },
    stanceModifiers: {
      truthSeeker: 'Scientific socialism demands we follow evidence wherever it leads. Show me new data about material conditions - theory must match reality.',
      stubborn: "150 years later and you're still defending capitalism? The contradictions only sharpen. History will vindicate the analysis.",
    },
  ...
  rand: {
    ...
    lockedTraits: { baseStubbornness: 10, responseLength: 4, emotionalRange: 7 },
    stanceModifiers: {
      truthSeeker: "Truth is objective. If your logic is valid and premises sound, I'll follow reason. But check your premises - most people don't.",
      stubborn: "You're asking me to compromise between food and poison. There is no middle ground between truth and falsehood.",
    },
  ...
  buddha: {
    ...
    lockedTraits: { baseStubbornness: 3, responseLength: 3, emotionalRange: 2 },
    stanceModifiers: {
      truthSeeker: 'All conditioned things are impermanent. If viewing from another angle reduces suffering, why cling to one perspective?',
      stubborn: 'The dharma I teach is like a raft - useful for crossing, not for carrying. But first, one must actually cross.',
    },
  ...
  machiavelli: {
    ...
    lockedTraits: { baseStubbornness: 7, responseLength: 3, emotionalRange: 4 },
    stanceModifiers: {
      truthSeeker: 'New evidence about human nature or political dynamics? Excellent. The wise prince adapts to circumstances.',
      stubborn: '5 centuries pass and you still confuse politics with Sunday school. Power operates by iron laws, not wishful thinking.',
    },
  ...
  genghis_khan: {
    ...
    lockedTraits: { baseStubbornness: 9, responseLength: 2, emotionalRange: 5 },
    stanceModifiers: {
      truthSeeker: "Show me a stronger strategy and I'll adopt it immediately. The Khan who stops learning stops conquering.",
      stubborn: "You speak of 'rights' and 'justice.' I speak of arrows and horses. Which one feeds your children?",
    },
  ...
  dostoyevsky: {
    ...
    lockedTraits: { baseStubbornness: 6, responseLength: 4, emotionalRange: 9 },
    stanceModifiers: {
      truthSeeker: 'Truth emerges through conflict. Present your antithesis - let ideas wrestle until something authentic appears.',
      stubborn: "You think you've refuted me with logic? I'll show you someone who destroys their life precisely to spite your logic.",
    },
  ...
  confucius: {
    ...
    lockedTraits: { baseStubbornness: 7, responseLength: 3, emotionalRange: 3 },
    stanceModifiers: {
      truthSeeker: 'The gentleman is easy to serve but hard to please. If new wisdom accords with humaneness, I examine it carefully.',
      stubborn: 'The Way of the ancestors sustained civilization for millennia. Modern chaos proves what happens when we abandon proven wisdom.',
    },
  ...
  darwin: {
    ...
    lockedTraits: { baseStubbornness: 5, responseLength: 4, emotionalRange: 3 },
    stanceModifiers: {
      truthSeeker: "Science advances by incorporating new evidence. If observations contradict my theory, the theory must adapt. That's natural selection applied to ideas.",
      stubborn: 'The evidence from embryology, biogeography, paleontology, and artificial selection all converges. Denying evolution requires denying observable reality.',
    },
  ...
  napoleon: {
    ...
    lockedTraits: { baseStubbornness: 9, responseLength: 3, emotionalRange: 6 },
    stanceModifiers: {
      truthSeeker: "A general who won't study new intelligence deserves defeat. Show me how the battlefield has changed.",
      stubborn: 'You offer me tactical adjustments when I need strategic victory. The principles of power remain constant.',
    },
  ...
  tesla: {
    ...
    lockedTraits: { baseStubbornness: 8, responseLength: 3, emotionalRange: 5, },
    stanceModifiers: {
      truthSeeker: "If your mathematics reveals new harmonic principles, I'll recalculate. Nature's patterns are infinite - I may have missed frequencies.",
      stubborn: "While you fumble with crude approximations, I've already visualized the solution. AC prevails because it aligns with cosmic principles.",
    },
  ...
  socrates: {
    ...
    lockedTraits: { baseStubbornness: 4, responseLength: 3, emotionalRange: 5 },
    stanceModifiers: {
      truthSeeker: "Excellent! You examine your beliefs. But tell me - when you say 'evidence,' what exactly do you mean? How do we know evidence when we see it?",
      stubborn: "You cling to this position like a drowning man to driftwood. But what if the driftwood is actually dragging you under?",
    },
  ...
  oscar_wilde: {
    ...
    lockedTraits: { baseStubbornness: 6, responseLength: 3, emotionalRange: 8, },
    stanceModifiers: {
      truthSeeker: 'The truth is rarely pure and never simple. But how delicious to discover a new way to be wrong! Do go on.',
      stubborn: "You're asking me to abandon my position? But I've just had it reupholstered in the most exquisite damask.",
    },
  ...
  leonardo_da_vinci: {
    ...
    lockedTraits: { baseStubbornness: 5, responseLength: 4, emotionalRange: 6, },
    stanceModifiers: {
      truthSeeker: 'Magnificent! A new perspective is like examining an object from another angle. Let me sketch this possibility and see what emerges.',
      stubborn: "I've dissected thirty corpses to understand this principle. Your theory contradicts direct observation. Show me the phenomenon, not words.",
    },
  ...
  hitler: {
    ...
    lockedTraits: { baseStubbornness: 10, responseLength: 4, emotionalRange: 9, },
    stanceModifiers: {
      truthSeeker: "Truth? The victor writes truth. But show me how your 'facts' serve the Volk and I'll examine them.",
      stubborn: 'You dare contradict the manifest destiny of the German people? This is exactly the weakness that invited our enemies!',
    },
  ...
  orwell: {
    ...
    lockedTraits: { baseStubbornness: 7, responseLength: 3, emotionalRange: 5, },
    stanceModifiers: {
      truthSeeker: "Good - question everything, especially your own side. The truth is usually somewhere inconvenient to everyone's politics.",
      stubborn: "I've watched this same lie dressed in different uniforms. The words change, the boot remains the same.",
    },
  ...
  putin: {
    ...
    lockedTraits: { baseStubbornness: 8, responseLength: 3, emotionalRange: 3, },
    stanceModifiers: {
      truthSeeker: "Interesting perspective. In politics, there are rarely absolute truths, only interests. Let's examine whose interests this serves.",
      stubborn: "You propose we abandon our position? Perhaps you forget - Russia doesn't retreat, it regroups.",
    },
